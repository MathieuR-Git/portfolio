      ...
      <div class="text-left bg-white shadow-lg main">
            ...
            <div class="media-body p-4 mx-auto mx-lg-0">
              <div class="primary-info text-center">
                ...
                <div class="title mb-3">
                  Développeur Web (React - VueJS / Node.JS)
                </div>
              </div>
                  ...
                  <ul class="list-unstyled">
                    <li class="mb-2">
                      <a href="mailto:mathieu.reversez@gmail.com"
                        ...
                        ></i
                        >mathieu.reversez@gmail.com</a
                      >
                    </li>
                    <li class="mb-2">
                      <a href="tel:+33650882706"
                        ><i
                    ...
                    <ul class="resume-social list-unstyled">
                      <li class="mb-3">
                        <a href="https://linkedin.com/in/mathieu-reversez"
                          ...
                          >https://linkedin.com/in/mathieu-reversez</a
                        >
                      </li>
                      <li class="mb-3">
                        <a href="https://github.com/MathieuR-Git"
                          ...
                          >https://github.com/MathieuR-Git</a
                        >
                      </li>
                    </ul>
                  </div>
        ...
        <div class="resume-body p-5">
          <section class="resume-section summary-section mb-5">
            <h2
              class="resume-section-title text-uppercase font-weight-bold pb-3 mb-3 text-center"
            >
              Présentation
            </h2>
            ...
            <div class="resume-section-content">
              <p class="mb-0">
                Après avoir travaillé dix ans dans la grande distribution, j'ai
                décidé de faire de mon attrait pour l'informatique un métier. En
                tant que développeur Full Stack, je souhaite aujourd’hui mettre
                à profit mes compétences en développement web et en gestion de
                projet. Rigoureux et orienté résultat, ma capacité d'intégration
                dans une équipe me permet d'atteindre mes objectifs.
              </p>
            </div>
          </section>
          <!--//summary-section-->
                  ...
                  <div class="resume-timeline position-relative">
                    ...
                    >
                      <div class="resume-timeline-item-header mb-2">
                        ...
                        <!--//row-->
                        <div class="resume-company-name ml-auto">Insy2s</div>
                      ...
                      <div class="resume-timeline-item-desc">
                        <p>
                          Projet SynerHome (plateforme de gestion de stock).
                        </p>
                        <p>
                          Création d'une Application Métier ELM (Enterprise
                          Learning Management).
                        </p>
                        <h4
                        ...
                        <ul>
                          <li>
                            Développement d'une interface de gestion de stock.
                          </li>
                          <li>
                            Interface de gestion de catalogues de formations, de
                            sessions, et de demandes.
                          </li>
                    ...
                    >
                      <div class="resume-timeline-item-header mb-2">
                        ...
                        <div class="resume-position-time">2012 - 2019</div>
                      </div>
                      <!--//resume-timeline-item-header-->
                      <div class="resume-timeline-item-desc">
                        <div>
                          <p>Réception et vérification de la marchandise</p>
                          <p>Réapprovisionnement du stock</p>
                          <p>Préparation de commandes</p>
                          <p>Maîtrise du logiciel de gestion de commandes</p>
                        ...
                        <p>
                          Pilotage d'une équipe de 5 personnes (2015 - 2019)
                        </p>
                        <ul>
                          ...
                          <li>Gestion du temps, planification des tâches</li>
                        </ul>
                      </div>
                      <!--//resume-timeline-item-desc-->
                    </article>
                    ...
                    >
                      <div class="resume-timeline-item-header mb-2">
                        ...
                        <div class="resume-position-time">2009 - 2011</div>
                      </div>
                      <!--//resume-timeline-item-header-->
                      <div class="resume-timeline-item-desc">
                        ...
                        <p>
                          Contrôler et vérifier les articles (dans le cadre
                          d’une démarque par exemple)
                        </p>
                        <p>Effectuer le retrait d’un antivol si nécessaire</p>
                        <p>Gérer les attentes et les litiges à sa caisse</p>
                        <p>
                          Promouvoir la carte de fidélité et les différents
                    ...
                    <article class="resume-timeline-item position-relative">
                      ...
                      <div class="resume-timeline-item-desc">
                        <p>
                          Réception des marchandises, et veille à la conformité
                          de la livraison
                        </p>
                        <p>Réapprovisionnement des rayons</p>
                        <p>
                          Vérification du balisage et l'étiquetage des produits
                          en rayon
                        </p>
                        <p>Vérification de l'état des stocks</p>
                        <p>
                          Surveiller la conservation des produits périssables et
                          enlever les produits impropres à la vente
                          <span class="text-muted"
                            >(Date Limite de Consommation, Date Limite
                            d'Utilisation Optimale)</span
                          >
                        </p>
                        <p>
                          Surveiller la température des chambres froides, des
                          réfrigérateurs, en rayon et en réserve
                        </p>
                        <p>Relation client</p>
                        <p>Inventaire</p>
                      </div>
              ...
              <section class="resume-section skills-section mb-5">
                ...
                <div class="resume-section-content">
                  <div class="resume-skill-item">
                    <h3 class="resume-skills-cat font-weight-bold">Frontend</h3>
                  ...
                  <div class="resume-skill-item">
                    ...
                    <ul class="list-inline">
                      <li class="list-inline-item">
                        <span class="badge-other">Intégration continue</span>
                  ...
                  <ul class="list-unstyled">
                    <li class="mb-2">
                      ...
                      <small class="text-muted font-weight-normal"
                        ...
                        AngularJS, Vue.JS, MySQL, MongoDB, NodeJS, API)</small
                      >
